...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-orange-50 to-white">
      ...
      <section className="py-4 px-4">
        <div>
          <h2 className="text-2xl text-center md:text-3xl font-bold mb-4 bg-gradient-to-r from-[#FF4500] to-[#FF6B00] bg-clip-text text-transparent">
            Our Journey
          </h2>
          <p className="text-gray-800 text-lg text-center leading-relaxed mb-4">
      ...
      <section className="py-4 pb-8 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-[1.618rem] p-8 shadow-xl border border-orange-100 text-center">
            <h2 className="text-2xl bg-gradient-to-r from-[#FF4500] to-[#FF6B00] bg-clip-text text-transparent font-bold mb-8 text-black">
