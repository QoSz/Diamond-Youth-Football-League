  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-orange-50 to-white px-4 py-12">
      <div className="mx-auto max-w-4xl text-center">
        <h1 className="text-3xl font-bold text-transparent md:text-4xl bg-gradient-to-r from-[#FF4500] to-[#FF6B00] bg-clip-text">
          About Us
        </h1>
      </div>
      ...
      <section className="mx-auto mt-12 max-w-3xl text-center">
        <h2 className="text-xl font-semibold text-transparent md:text-2xl bg-gradient-to-r from-[#FF4500] to-[#FF6B00] bg-clip-text">
          Our Journey
        </h2>
